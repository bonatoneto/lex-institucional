...
const Video: FC<VideoProps> = ({ slice }) => {
  ...
  return (
    <section
      ...
      className="relative w-full overflow-hidden min-h-dvh md:rounded-b-[52px]"
    >
      <video
          ...
          <div className="relative flex flex-col gap-14 justify-center items-center min-h-dvh w-full text-white px-6 z-30">
            <div className="flex flex-col items-center gap-5">
              <AnimateOnView delay={0}>
                <div className="font-baloo text-5xl lg:text-[4rem] leading-none font-semibold lg:text-center">
                  <PrismicRichText field={slice.primary.title} />
                </div>
              </AnimateOnView>
              <AnimateOnView delay={0.15}>
                <div className="font-nunito text-2xl font-medium lg:text-center">
                  <PrismicRichText field={slice.primary.description} />
                </div>
              </AnimateOnView>
            </div>
            <AnimateOnView delay={0.3} className="w-full flex justify-center">
